...
export const promptForConfig = () => {
    ...
    const mnemonicInput = readlineSync.question('Enter Wallet Mnemonic (Press enter to use default value): ', { hideEchoBack: true });
    ...
    const mnemonic = mnemonicInput || process.env.MNEMONIC || 'verify sustain lumber boat demise parade special soft bargain scout spoil there addict move badge rebuild horn achieve hollow acquire glide bundle curious present';
