...
export const HYPERSIGN_NETWORK_DID_EP="api/v1/did/"
...
export const HYPERSIGN_NETWORK_DID_PATH="/hypersign-protocol/hidnode/did"
export const HYPERSIGN_NETWORK_SCHEMA_PATH="/hypersign-protocol/hidnode/did/schema"
