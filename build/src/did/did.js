...
var HypersignDID = /** @class */ (function () {
    ...
    HypersignDID.prototype.sign = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var privateKey, challenge, domain, did, didDocument, verificationMethodId, resolveddoc, error_1, publicKeyId, pubkey, publicKeyMultibase1, keyPair, suite, didDocumentLd, signedDidDocument;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        privateKey = params.privateKey, challenge = params.challenge, domain = params.domain, did = params.did, didDocument = params.didDocument, verificationMethodId = params.verificationMethodId;
                        if (!privateKey) {
