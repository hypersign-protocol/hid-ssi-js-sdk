...
describe('DID Opearations', () => {
    describe('#generate() to generate did', function () {
        ...
        it('should be able to generate didDocument for holder', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const kp = yield hypersignDID.generateKeys();
    ...
    describe('#register() this is to register did on the blockchain', function () {
        ...
        it('should be able to register holder didDocument in the blockchain', function () {
            return __awaiter(this, void 0, void 0, function* () {
    ...
    describe('#sign() method to sign presentation document', () => {
        ...
        it('should not be able to sign presentation as either holderDid or holderDidDocSigned is required but passed both', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                tempSignPresentationBody.presentation = {};
                tempSignPresentationBody.verificationMethodId = holderDidDocument.verificationMethod[0].id;
                tempSignPresentationBody.holderDid = holderDidDocument.id;
                return hypersignVP.sign(tempSignPresentationBody).catch(function (err) {
                    (0, chai_1.expect)(function () {
    ...
    describe('#verify() method to verify a signed presentation document', () => {
        ...
        it('should not be able to verify presentation as challenge used at the time of verification is different than challenge used in vp sign and getting presentation verification result false', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                (0, chai_1.expect)(verifiedPresentationDetail.presentationResult.verified).to.be.equal(false);
        ...
        it('should be able to verify signed presentation document', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(verifiedPresentationDetail.presentationResult.verified).to.be.equal(true);
            ...
            (0, chai_1.should)().exist(verifiedPresentationDetail.credentialResults[0].results);
            (0, chai_1.expect)(verifiedPresentationDetail.credentialResults[0].results).to.be.a('array');
            (0, chai_1.expect)(verifiedPresentationDetail.credentialResults[0].verified).to.be.equal(true);
