...
export declare const DID_BabyJubJubKey2021: {
    CONTROLLER_CONTEXT: string;
    SCHEME: string;
    METHOD: string;
    NAMESPACE: string;
    DID_BASE_CONTEXT: string;
    DID_KEYAGREEMENT_CONTEXT: string;
    DID_BABYJUBJUBKEY2021: string;
    BABYJUBJUBSIGNATURE: string;
    VERIFICATION_METHOD_TYPE: string;
    BLOCKCHAINACCOUNTID_CONTEXT: string;
    SIGNATURE_TYPE: ProofTypes;
};
...
export declare const VC: {
    ...
    CREDENTIAL_STATUS_CONTEXT: string;
    CONTEXT_HypersignCredentialStatus2023: string;
...
export declare const GAS_FEE_API_URL: (baseUrl: any) => string;
export declare const GAS_FEE_METHODS: {
    Register_Did: string;
    Update_Did: string;
    Deactivate_Did: string;
    Register_Cred_Schema: string;
    Update_Cred_Schema: string;
    Register_Cred_Status: string;
    Update_Cred_Status: string;
};
