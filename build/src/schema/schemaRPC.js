...
var SchemaRpc = /** @class */ (function () {
    function SchemaRpc(_a) {
        ...
        if (offlineSigner) {
            ...
            this.schemaRestEp = nodeRestEndpoint
                ? utils_1.default.checkUrl(nodeRestEndpoint) + constants_1.HYPERSIGN_NETWORK_SCHEMA_PATH
                : utils_1.default.checkUrl(constants_1.HYPERSIGN_TESTNET_REST) + constants_1.HYPERSIGN_NETWORK_SCHEMA_PATH;
        }
    }
    ...
    SchemaRpc.prototype.createSchema = function (schema, proof) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SchemaRpc.prototype.resolveSchema = function (schemaId) {
        return __awaiter(this, void 0, void 0, function () {
            var getSchemaUrl, response, schema;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        getSchemaUrl = "".concat(this.schemaRestEp, "/").concat(schemaId, ":");
                        return [4 /*yield*/, axios_1.default.get(getSchemaUrl)];
                    case 1:
                        response = _a.sent();
