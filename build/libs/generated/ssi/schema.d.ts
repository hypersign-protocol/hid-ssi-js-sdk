...
export declare const SchemaDocument: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): SchemaDocument;
...
export declare const SchemaProperty: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): SchemaProperty;
...
export declare const SchemaProof: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): SchemaProof;
...
export declare const Schema: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): Schema;
