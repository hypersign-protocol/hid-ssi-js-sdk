...
var HyperSignSchema = /** @class */ (function () {
    ...
    // Ref:
    HyperSignSchema.prototype.getSchemaId = function (author) {
        var a = author;
        var b = (0, uuid_1.v4)();
        var id = "".concat(a, ";id=").concat(b, ";version=").concat(this.modelVersion); // ID Structure ->  did:hs:<a>;id=<b>;version=1.0
        return id;
    };
