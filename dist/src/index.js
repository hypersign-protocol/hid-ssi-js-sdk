...
module.exports = /** @class */ (function () {
    function HypersignSSISdk(offlineSigner, nodeEndpoint, nodeRestEndpoint) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        console.log('hID wallet address in init()' + client_1.HIDClient.getHidWalletAddress());
                        this.did = new did_1.default();
                        this.schema = new schema_1.default();
                        this.vc = new vc_1.default();
                        this.vp = new vp_1.default();
                        return [2 /*return*/];
                }
            });
        });
